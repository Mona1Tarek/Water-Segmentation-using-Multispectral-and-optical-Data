...
def capture_face_images(user_id, save_path='/home/mona/Face recognition/database', num_images=5):
    ...
    while count < num_images:
        ...
        for (x, y, w, h) in faces:
            ...
            # Check if the user pressed 'c' and the face is in the correct position
            if key == ord('c'):
                # Simple logic to enforce instructions (this can be improved)
                if count == 0:  # Look straight
                    ...
                    if x + w/2 < frame.shape[1]/2 - 50:
                        ...
                        print("Please turn your head slightly to the left!")
                    ...
                    if x + w/2 > frame.shape[1]/2 + 50:
                        ...
                        print("Please turn your head slightly to the right!")
                    ...
                    if y + h/2 > frame.shape[0]/2 + 50:
                        ...
                        print("Please look down slightly!")
